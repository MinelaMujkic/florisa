    ...
    <div class="header">
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <a href="{{url("/")}}">
                    <img class="logo" src="florisa_logo.png" height="50px">
                </a>
            </div>
            <div class="col-lg-4 col-md-12 col-sm-12 menubar">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><i class="fas fa-envelope"></i>Email: <a
                                    href="mailto:florisa@gmail.com">florisa@gmail.com</a></p>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12">
